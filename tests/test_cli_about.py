...
def test_flag_about_CLI_command_output_from_cli_command_about():
    ...
    return Expect(result.output).to_equal('Made with \U0001F40D (Python) by Alexandra McCarroll, Tom Betts, Richard Hewitt, Hemesh Unka (February 2018 Cohort - Makers Academy)\n')
