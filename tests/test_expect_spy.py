...
def test_to_have_been_called_knows_when_spy_has_been_called():
    ...
    hello = Spy(hello)
    hello()
    return Expect(Expect(hello).to_have_been_called()['result']).to_equal(True)

def test_to_have_been_called_knows_when_spy_has_not_been_called():
    def hello(name):
        print(f'hello {name}')
    hello = Spy(hello)
    return Expect(Expect(hello).to_have_been_called()['result']).to_equal(False)

def test_to_have_been_called_gives_reason_for_fail():
    def hello(name):
        print(f'hello {name}')
    hello = Spy(hello)
    return Expect(Expect(hello).to_have_been_called()['reason']).to_equal('Spied upon function was not called')
...
def test_to_have_been_called_with_args_passes_if_args_match():
    ...
    hello = Spy(hello)
    hello('helloworld')
    return Expect(Expect(hello).to_have_been_called_with_args('helloworld')['result']).to_equal(True)
...
def test_to_have_been_called_with_args_fails_if_args_do_not_match():
    ...
    hello = Spy(hello)
    hello(10,'helloworld')
    return Expect(Expect(hello).to_have_been_called_with_args(10)['result']).to_equal(False)
...
def test_to_have_been_called_with_args_provides_reason_if_args_do_not_match():
    ...
    hello = Spy(hello)
    hello(10,'helloworld')
    return Expect(Expect(hello).to_have_been_called_with_args(10,'what')['reason']).to_equal("Expected args: (10, 'what')\nGot args: (10, 'helloworld')")
...
def test_to_have_been_called_times_comparison_must_be_an_integer():
    def hello(name):
        print(f'hello {name}')
    hello = Spy(hello)
    return Expect(Expect(hello).to_have_been_called_times('hello')['reason']).to_equal('Argument must be an integer')
...
def test_to_have_been_called_times_passes_when_amount_of_calls_match():
    ...
    hello()
    hello()
    return Expect(Expect(hello).to_have_been_called_times(2)['result']).to_equal(True)
...
def test_to_have_been_called_times_provides_reason_if_amount_of_calls_do_not_match():
    ...
    hello = Spy(hello)
    hello()
    return Expect(Expect(hello).to_have_been_called_times(3)['reason']).to_equal('Expected calls: 3\nGot calls: 1')
